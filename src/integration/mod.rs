...
pub(crate) use env::{
    apply_pane_base_env, NAGI_PANE_ID_ENV_VAR, NAGI_TAB_ID_ENV_VAR, NAGI_WORKSPACE_ID_ENV_VAR,
};
...
const PI_EXTENSION_INSTALL_NAME: &str = "nagi-agent-state.ts";
const PI_EXTENSION_ASSET: &str = include_str!("assets/pi/nagi-agent-state.ts");
const PI_INTEGRATION_VERSION: u32 = 5;
const OMP_EXTENSION_INSTALL_NAME: &str = "nagi-omp-agent-state.ts";
const OMP_EXTENSION_ASSET: &str = include_str!("assets/omp/nagi-agent-state.ts");
const OMP_INTEGRATION_VERSION: u32 = 5;
const CLAUDE_HOOK_INSTALL_NAME: &str = if cfg!(windows) {
    "nagi-agent-state.ps1"
} else {
    "nagi-agent-state.sh"
};
const CLAUDE_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/claude/nagi-agent-state.ps1")
} else {
    include_str!("assets/claude/nagi-agent-state.sh")
};
...
const CODEX_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/codex/nagi-agent-state.ps1")
} else {
    include_str!("assets/codex/nagi-agent-state.sh")
};
...
const KIMI_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/kimi/nagi-agent-state.ps1")
} else {
    include_str!("assets/kimi/nagi-agent-state.sh")
};
const KIMI_INTEGRATION_VERSION: u32 = 4;
const KIMI_CONFIG_BLOCK_BEGIN: &str = "# >>> nagi kimi integration";
const KIMI_CONFIG_BLOCK_END: &str = "# <<< nagi kimi integration";
...
const COPILOT_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/copilot/nagi-agent-state.ps1")
} else {
    include_str!("assets/copilot/nagi-agent-state.sh")
};
...
const DEVIN_HOOK_INSTALL_NAME: &str = "nagi-agent-state.sh";
const DEVIN_HOOK_ASSET: &str = include_str!("assets/devin/nagi-agent-state.sh");
...
const DROID_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/droid/nagi-agent-state.ps1")
} else {
    include_str!("assets/droid/nagi-agent-state.sh")
};
...
const OPENCODE_PLUGIN_INSTALL_NAME: &str = "nagi-agent-state.js";
const OPENCODE_PLUGIN_ASSET: &str = include_str!("assets/opencode/nagi-agent-state.js");
const OPENCODE_INTEGRATION_VERSION: u32 = 8;
const KILO_PLUGIN_INSTALL_NAME: &str = "nagi-agent-state.js";
const KILO_PLUGIN_ASSET: &str = include_str!("assets/kilo/nagi-agent-state.js");
const KILO_INTEGRATION_VERSION: u32 = 2;
const HERMES_PLUGIN_INSTALL_NAME: &str = "nagi-agent-state";
...
const QODERCLI_HOOK_ASSET: &str = if cfg!(windows) {
    include_str!("assets/qodercli/nagi-agent-state.ps1")
} else {
    include_str!("assets/qodercli/nagi-agent-state.sh")
};
...
const CURSOR_HOOK_INSTALL_NAME: &str = "nagi-agent-state.sh";
const CURSOR_HOOK_ASSET: &str = include_str!("assets/cursor/nagi-agent-state.sh");
const CURSOR_INTEGRATION_VERSION: u32 = 1;
const MASTRACODE_HOOK_INSTALL_NAME: &str = "nagi-agent-state.sh";
const MASTRACODE_HOOK_ASSET: &str = include_str!("assets/mastracode/nagi-agent-state.sh");
...
const INTEGRATION_VERSION_MARKER: &str = "NAGI_INTEGRATION_VERSION=";
