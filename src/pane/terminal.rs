...
use super::{
    input::{
        ...
        ghostty_mouse_event_from_wheel_kind, ghostty_prefers_nagi_text_encoding,
    },
...
impl GhosttyPaneTerminal {
    ...
    pub fn encode_terminal_key(
        ...
        if ghostty_prefers_nagi_text_encoding(key) {
...
mod tests {
    ...
    #[test]
    fn ghostty_char_keys_still_use_nagi_encoding() {
        let (tx, _rx) = mpsc::channel(4);
        let mut terminal = crate::ghostty::Terminal::new(80, 24, 0).unwrap();
