...
const FAKE_ANNOUNCEMENT_BODY_ENV: &str = "NAGI_FAKE_PRODUCT_ANNOUNCEMENT_BODY";
const FAKE_ANNOUNCEMENT_BODY_FILE_ENV: &str = "NAGI_FAKE_PRODUCT_ANNOUNCEMENT_BODY_FILE";
const FAKE_ANNOUNCEMENT_ID_ENV: &str = "NAGI_FAKE_PRODUCT_ANNOUNCEMENT_ID";
const FAKE_ANNOUNCEMENT_TITLE_ENV: &str = "NAGI_FAKE_PRODUCT_ANNOUNCEMENT_TITLE";
...
mod tests {
    ...
    fn temp_path(name: &str) -> PathBuf {
        std::env::temp_dir().join(format!(
            "nagi-product-announcements-{name}-{}-{}.json",
            std::process::id(),
