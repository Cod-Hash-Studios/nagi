...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=NAGI_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=NAGI_BUILD_ID");
    println!("cargo:rerun-if-env-changed=NAGI_BUILD_COMMIT");
